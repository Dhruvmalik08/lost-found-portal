    ...
    if (empty($name) || empty($category) || empty($location) || empty($date)) {
        ...
        if (empty($error)) {
            $sql = "INSERT INTO items (user_id, type, name, description, category, location, date_occurred, photo)
                    VALUES ('$user_id', 'lost', '$name', '$description', '$category', '$location', '$date', '$photo_name')";
            if (mysqli_query($conn, $sql)) {
                $success = "Your lost item has been posted successfully!";
            } else {
...
<head>
  ...
  <title>Post Lost Item – Lost & Found Portal</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .upload-zone:hover { border-color: var(--danger); background: rgba(224,82,82,0.04); }
    ...
    .upload-text strong { color: var(--danger); }
...
<aside class="sidebar">
  ...
  <nav class="nav">
    ...
    <a href="post-lost.php" class="active"><span>📋</span> Post Lost Item</a>
...
<!-- MAIN -->
<main class="main">
  <div class="page-title">Post a Lost Item</div>
  <div class="page-sub">Fill in the details below so others can help identify and return your item.</div>
  ...
  <div class="form-card">
    <form method="POST" action="" enctype="multipart/form-data">
      ...
      <div class="form-actions">
        <button type="submit" name="submit" class="btn btn-danger">Post Lost Item</button>
